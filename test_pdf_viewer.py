...
def test_display_pdf():
    """Tests that the PDF display function reads files correctly without testing UI."""
    ...
    try:
        ...
        with patch("streamlit.markdown") as mock_markdown:
            ...
            assert expected_base64 in mock_markdown.call_args[0][0]  # Ensure the PDF was encoded correctly
    finally:
